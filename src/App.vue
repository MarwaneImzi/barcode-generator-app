...
<template>
  <div>
    <div>
      <!-- input area -->
      <div
        class="text-gray-400 bg-slate-900 body-font relative h-full min-h-screen"
      >
        <div class="container px-5 pt-24 mx-auto noPrint">
          <div class="flex flex-col text-center w-full mb-12">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
              Generate barcodes for printing and scanning
            </p>
          </div>
          <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
              <div class="p-2 w-full">
                <div class="relative">
                  <label for="barcode" class="leading-7 text-sm text-gray-400"
                    >Barcode (Code128)</label
                  >
                  <input
                    type="text"
                    v-model.trim="barcode"
                    v-on:keyup.enter="SaveBarcode"
              ...
              <div
                class="p-2 w-full pt-8 mt-8border-t border-gray-800 text-center"
              ></div>
            </div>
          </div>
        </div>
        ...
        <div class="container mx-auto">
          <div class="noPrint hidden" style>
            {{
              (listViewCSS = !viewToggle
                ? "flex flex-wrap-reverse justify-center"
                : "flex flex-col flex-col-reverse justify-center")
            }}
          </div>
  ...
  <footer class="text-gray-400 bg-slate-900 body-font noPrint">
    ...
    >
      ...
      >
        © 2023 Marwane —
        <a
          href="https://github.com/MarwaneImzi"
